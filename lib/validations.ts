...
export const AskQuestionSchema = z.object({
	...
	content: z
		.string()
		.min(1, {message: 'Content must be at least 20 characters long.'}),
	tags: z
		.array(
			z
				.string()
...
export const AIAnswerSchema = z.object({
	...
	content: z
		.string()
		.min(50, { message: "Answer must be at least 100 characters long." }),
})
...
export const CreateInteractionSchema = z.object({
	action: z.enum(InteractionActionEnums, {message: "Invalid action type"}),
	actionTarget: z.enum(['question', 'answer'], {message: "Invalid action type"}),
