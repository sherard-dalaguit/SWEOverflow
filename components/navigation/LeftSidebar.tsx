	...
	return (
		<section className="custom-scrollbar background-light900_dark200 light-border sticky left-0 top-0 h-screen flex flex-col justify-between overflow-y-auto border-r p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]">
			...
			<div className="flex flex-col gap-3">
				<Button className="btn-secondary text-dark400_light900 primary-gradient min-h-[41px] w-full rounded-lg px-4 py-3 shadow-none" asChild>
				...
				<Button className="btn-tertiary text-dark400_light900 min-h-[41px] w-full rounded-lg border px-4 py-3 shadow-none" asChild>
